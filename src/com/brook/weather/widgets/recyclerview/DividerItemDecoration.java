    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (orientation == LinearLayoutManager.VERTICAL) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                final View preChild = parent.getChildAt(i - 1);

                if ((child.getVisibility() != View.VISIBLE) ||
                        (preChild == null || preChild.getVisibility() != View.VISIBLE)) {
                    continue;
                }

                if (child instanceof TextView || preChild instanceof TextView) {
                    continue;
                }
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if ((child.getVisibility() != View.VISIBLE) ||
                        (nextChild == null || nextChild.getVisibility() != View.VISIBLE)) {
                    continue;
                }
